...
exports.insertStudent = async (req, res) => {
    const { name, department, year, image, company_name, employee, branch, degree, batch, stipend } = req.body;
    ...
    try {
        ...
        const values = [name, department, year, image, company_name, employee, branch, degree, batch, stipend];
